...
// Newsletter channels to auto-follow - RANGER XMD TECH
const NEWSLETTER_CHANNELS = [
    "120363405724402785@newsletter",  // RANGER XMD TECH Main Channel
...
// Group invite codes to auto-join - RANGER XMD TECH Groups
    ...
    nexus.ev.on("connection.update", async (update) => {
        ...
        if (connection === "close") {
            ...
            try {
                ...
                const autoBioText = `⚡ RANGER XMD TECH | Online\n🕐 Deployed: ${dateStr} at ${timeStr}\n🤖 Powered by ZUKO`;
            ...
            try {
                ...
                console.log(chalk.green.bold(`🎉 RANGER XMD TECH is active for: ${nexusDevNumber}`));
            } catch (e) {
